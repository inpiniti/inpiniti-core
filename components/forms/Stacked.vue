<template>
  <form class="bg-white p-4 rounded-xl">
        ...
        <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
          ...
          <div class="col-span-full">
            ...
            <div class="mt-2 flex items-center gap-x-3">
              <div
                class="flex items-end justify-center h-9 w-9 rounded-full overflow-hidden text-white bg-gray-300 border-2 border-gray-300"
              >
                <font-awesome-icon class="text-3xl" :icon="['fas', 'user']" />
              </div>
              <button
                type="button"
